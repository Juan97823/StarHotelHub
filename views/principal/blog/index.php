    ...
    <div class="container">
        ...
        <div class="row g-4 mt-4">
                        ...
                        <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                            <div class="position-relative">
                                <a href="<?php echo RUTA_PRINCIPAL . 'blog/detalle/' . $entrada['slug']; ?>">
                                    <img src="<?php echo RUTA_PRINCIPAL . 'assets/img/entradas/' . $entrada['foto']; ?>"
                                        class="card-img-top img-fluid" alt="<?php echo $entrada['titulo']; ?>">
                                </a>
                            </div>
                            <div class="card-body p-4">
                                ...
                                <a class="btn btn-outline-primary btn-sm mt-2"
                                    href="<?php echo RUTA_PRINCIPAL . 'blog/detalle/' . $entrada['slug']; ?>">
            ...
            <?php } else { ?>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Descubre cómo StarHotelHub promueve el turismo responsable con energías
                                limpias, reciclaje y consumo responsable...</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Te contamos cómo nuestras suites ofrecen experiencias exclusivas con spa,
                                catas privadas y tours personalizados...</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                        <img src="assets/img/entradas/tecnologia-hotelera.jpg" class="card-img-top"
                            alt="Tecnología hotelera">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Desde check-in digital hasta habitaciones inteligentes, descubre cómo la
                                innovación mejora cada estadía...</p>
