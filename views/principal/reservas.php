                    ...
                    <div class="card-body">
                        ...
                        <form method="post" id="formulario"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="correo" name="correo" id="correo" class="form-control form-control-lg" required>
                            </div>
                            <!-- Fecha Llegada -->
                            <div class="mb-3">
                                <label for="f_llegada" class="form-label fw-semibold">Fecha Llegada</label>
                                <input type="text" class="form-control form-control-lg" id="f_llegada" name="f_llegada"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" id="f_salida" name="f_salida"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="habitacion" id="habitacion" class="form-select form-select-lg" required>
                                    ...
                                    <?php foreach ($data['habitaciones'] as $habitacion) { ?>
                                        <option value="<?php echo $habitacion['id']; ?>" <?php echo (isset($data['disponible']['habitacion']) && $habitacion['id'] == $data['disponible']['habitacion']) ? 'selected' : ''; ?>>
                        ...
                        <?php if (isset($data['habitacion'])): ?>
                            <div class="mt-4 card shadow-sm border-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <span class="badge bg-success fs-6"><?php echo $data['habitacion']['precio']; ?> / noche</span>
                                </div>
                            </div>
                        <?php endif; ?>
