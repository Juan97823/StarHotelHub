            ...
            <form id="formBlog" 
                ...
                <div class="mb-3">
                    ...
                    <textarea name="contenido" id="contenido" class="form-control" rows="6" 
                              placeholder="Escribe el contenido aquí..." required><?php echo htmlspecialchars($data['entrada']['descripcion']); ?></textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="imagen" id="imagen" class="form-control" accept="image/*" onchange="mostrarPreview(event)">
                    <div class="mt-2">
                        <img id="previewImg" src="" alt="Vista previa" class="img-thumbnail shadow-sm d-none" width="150">
                    </div>
