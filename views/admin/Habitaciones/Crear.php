                    ...
                    <form action="<?php echo RUTA_PRINCIPAL . 'admin/habitaciones/guardar'; ?>" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="capacidad" class="form-control" type="number" name="capacidad"
                                    placeholder="Nº de personas" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="precio" class="form-label">Precio por Noche</label>
                                <input id="precio" class="form-control" type="text" name="precio" placeholder="0.00"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="descripcion" class="form-control" name="descripcion" rows="3"
                                placeholder="Describe la habitación" required></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="servicios" class="form-label">Servicios</label>
                            <textarea id="servicios" class="form-control" name="servicios" rows="3"
                                placeholder="Ej: Wifi, TV Cable, Baño privado" required></textarea>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?php echo RUTA_PRINCIPAL . 'admin/habitaciones'; ?>"
